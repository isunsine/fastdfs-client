...
<beans xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  <bean id="fastDFSFactory" class="com.sunsine.fastdfs.FastDFSTemplateFactory" init-method="init">
    <!--连接超时的时限，单位为秒-->
    ...
    <!--tracker的配置 ","逗号分隔-->
    <property name="tracker_servers" value="192.168.10.192:22122"/>
    <!--HTTP访问服务的端口号-->
    <property name="g_tracker_http_port" value="9999"/>
    <!--nginx的对外访问地址，如果没有端口号，将取g_tracker_http_port配置的端口号 ","逗号分隔-->
    <property name="nginx_address" value="192.168.10.192:9999"/>
  </bean>
