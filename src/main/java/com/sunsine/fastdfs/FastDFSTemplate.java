...
import com.sunsine.fastdfs.pool.ConnectionPoolFactory;
...
public class FastDFSTemplate {
	 ...
	 * @throws FastDFSException
	 */
	public FastDfsInfo upload(byte[] data, String ext, Map<String, String> values)
		throws FastDFSException {
	 ...
	 * @throws FastDFSException
	 */
	public byte[] loadFile(FastDfsInfo dfs)
		throws FastDFSException {
